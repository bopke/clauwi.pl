/* eslint-disable */
// Generated by Wrangler by running `wrangler types --env-interface=CloudflareEnv cloudflare-env.d.ts` (hash: ad6d8f23345ef500a6f27f02532c395c)
// Runtime types generated with workerd@1.20260721.1 2026-06-26 global_fetch_strictly_public,nodejs_compat
interface __BaseEnv_CloudflareEnv {
	MEDIA: R2Bucket;
	DB: D1Database;
	clauwi_db: D1Database;
	ASSETS: Fetcher;
	NEXTJS_ENV: string;
	AUTH_SECRET: string;
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "NEXTJS_ENV" | "AUTH_SECRET" | "AUTH_GOOGLE_ID" | "AUTH_GOOGLE_SECRET" | "BREVO_API_KEY" | "BREVO_SENDER_EMAIL" | "BREVO_SENDER_NAME" | "CONTACT_FORM_TO" | "TURNSTILE_SECRET_KEY" | "COURSE_ORGANIZER_EMAIL" | "EMAIL_BASE_URL">> {}
}
